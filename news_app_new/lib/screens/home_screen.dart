...
class HomeScreen extends StatelessWidget {
  ...
  void fetchNews(String query) async {
    try {
      String url = 'https://newsapp-h1zb.onrender.com/api/news';
      if (query.isNotEmpty) {
        url = 'https://newsapp-h1zb.onrender.com/api/news/search?q=$query';
      } else if (selectedCategory.value.isNotEmpty) {
        url = 'https://newsapp-h1zb.onrender.com/api/news/category/${selectedCategory.value}';
      }
